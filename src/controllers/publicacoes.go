...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusInternalServerError,
			errors.New("não é possível apagar uma publicação que não seja sua"),
		)
		return
	}
...
// BuscarPublicacoesPorUsuario: traz as publicações de um usuário
...
// CurtirPublicacao: adiciona uma curtina na publicacao
...
// DescurtirPublicacao: adiciona uma curtina na publicacao
